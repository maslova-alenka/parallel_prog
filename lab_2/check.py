...
PATH = 'C:/Repository/lab_parallel_prog/lab_2/matrix/'
PATH_2 = 'C:/Repository/lab_parallel_prog/lab_2/'
PATH_3 = 'C:/Repository/lab_parallel_prog/lab_2/result/'
...
if __name__ == "__main__":
    ...
    files = [PATH_3 + "res_1_threads.txt", PATH_3 + "res_2_threads.txt", PATH_3 + "res_3_threads.txt", PATH_3 + "res_4_threads.txt"]
    labels = ["Threads 1", "Threads 2", "Threads 3", "Threads 4"] 
